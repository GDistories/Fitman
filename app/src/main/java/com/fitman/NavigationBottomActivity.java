...
import com.fitman.databinding.ActivityNavigationBottomBinding;
...
public class NavigationBottomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                R.id.navigation_home, R.id.navigation_sport, R.id.navigation_fitness, R.id.navigation_daily_attendance, R.id.navigation_my)
                .build();
