...
public class CalendarCardView extends View {
    ...
    public interface OnCellClickListener {
        ...
        void touchToLastMonth(boolean isLastMonth);
    }
    ...
    private void init(Context context) {
        ...
        mCirclePaint.setColor(Color.parseColor("#FC922C")); // 红色圆形
    ...
    private void fillDate() {
        ...
        boolean isLastMonth = DateUtil.isLastMonth(mShowDate);
...
//                }
                ...
                if (Math.abs(disX) > page_touch_slop && Math.abs(disX) > Math.abs(disY)) {
                    if (disX > 0){
                        if (mCellClickListener != null){
                            mCellClickListener.touchToLastMonth(true);
                        }
                    } else {
                        if (mCellClickListener != null){
                            mCellClickListener.touchToLastMonth(false);
                        }
                    }
                }
    ...
    public void setNewMonth(CustomDate customDate) {
